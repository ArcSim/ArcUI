...
function ns.Display.UpdateBar(barNumber, stacks, maxStacks, active, durationFontString, iconTexture, auraName, cachedConfig)
  ...
  elseif displayMode == "perStack" then
    ...
    -- Per-side fill padding (in physical px, converted to WoW units). Along the
    -- fill axis the padding stacks on top of the border inset; perpendicular to
    -- the fill it is padding-only so that zero padding keeps the current look.
