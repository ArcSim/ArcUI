  ...
  return {
    ...
    effectsGroup = {
      ...
      args = {
        pulseHint = {
          type = "description",
          name = "|cff888888Pulse and glow play while the aura is active, and preview here in the editor as you toggle them. The size pulse pauses only while you drag a resize handle.|r",
          order = 0,
          width = "full",
        },
        pulseEnabled = {
        ...
        glowEnabled = {
          type = "toggle",
          name = "Glow",
          desc = "Show a glow around the texture while the aura is active.",
          get = function() return GetDisplay("glowEnabled", false) end,
          set = function(_, v) SetDisplay("glowEnabled", v) end,
          order = 4,
          width = "full",
        },
        glowType = {
          type = "select",
          name = "Glow Style",
          values = { pixel = "Pixel Glow", autocast = "Autocast Shine", button = "Action Button Glow", proc = "Proc Glow" },
          get = function() return GetDisplay("glowType", "pixel") end,
          set = function(_, v) SetDisplay("glowType", v) end,
          order = 5,
          width = 1.5,
          disabled = function() return not GetDisplay("glowEnabled", false) end,
        },
      },
    },
